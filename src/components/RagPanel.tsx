        ...
        <div className="flex-1 overflow-y-auto px-5 py-4">
          ...
          <div className="mb-4 grid grid-cols-3 gap-2">
            <div className="rounded-xl bg-muted px-3 py-2.5">
              <div className="text-[11px] text-muted-foreground">Chunks</div>
              <div className="text-[18px] font-semibold text-foreground">{stats?.chunks ?? "—"}</div>
            </div>
            <div className="rounded-xl bg-muted px-3 py-2.5">
              <div className="text-[11px] text-muted-foreground">Sources</div>
              <div className="text-[18px] font-semibold text-foreground">{stats?.sources ?? "—"}</div>
            </div>
            <div className="rounded-xl bg-card px-3 py-2.5 ring-1 ring-accent/20">
              <div className="text-[11px] text-accent flex items-center gap-1"><Sparkles size={10}/> Auto-RAG</div>
              <div className="text-[11px] leading-tight text-muted-foreground">Every message is enriched with citations automatically</div>
            </div>
          </div>
          ...
          <div className="mb-4 rounded-xl border border-border bg-card p-3">
            <div className="mb-2 text-[12px] font-medium text-muted-foreground">Add text</div>
            <input value={source} onChange={(e) => setSource(e.target.value)} placeholder="Source name e.g. SARS-VAT201-guide.pdf" className="mb-2 w-full rounded-lg bg-muted px-3 py-2 text-[13px] text-foreground placeholder:text-muted-foreground focus:outline-none" />
            <textarea value={text} onChange={(e) => setText(e.target.value)} placeholder="Paste your document, policy, prior-year note…" rows={5} className="w-full rounded-lg bg-muted px-3 py-2 text-[13px] text-foreground placeholder:text-muted-foreground focus:outline-none" />
            <button onClick={ingest} disabled={busy !== null || !text.trim()} className="mt-2 inline-flex items-center gap-2 rounded-lg bg-primary px-3.5 py-2 text-[13px] font-medium text-primary-foreground hover:brightness-110 disabled:opacity-40">
          ...
          {/* folder ingest */}
          <div className="mb-4 rounded-xl border border-border bg-card p-3">
            <div className="mb-2 text-[12px] font-medium text-muted-foreground">Add folder (PDF · docx · xlsx · md · txt)</div>
          ...
          <div className="rounded-xl border border-border bg-card p-3">
            <div className="mb-2 text-[12px] font-medium text-muted-foreground">Test retrieval</div>
            <div className="flex gap-2">
